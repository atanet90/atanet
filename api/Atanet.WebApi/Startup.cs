namespace Atanet.WebApi
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(x => x.AddProfiles(GetAssemblies().ToList()));
            ...
            ConfigureBusinessRules(services);
            ...
            services.AddSingleton<IAssemblyContainer>(x => new AssemblyContainer(GetAssemblies()));
        ...
        public static void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            const string subUrl = "";
            app.Map(subUrl, x => ConfigureCore(x, env));
        }

        private static void ConfigureCore(IApplicationBuilder app, IHostingEnvironment env)
        {
            app.UseCors();
        ...
        private static void ConfigureBusinessRules(IServiceCollection services)
        {
            var atanetAssemblies = GetAssemblies();
