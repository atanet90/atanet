namespace Atanet.Model.Validation
{
    ...
    public class PropertyName : IEquatable<PropertyName>
    {
        ...
        public static PropertyName Parse(string name) => new PropertyName(name);

        public bool Equals(PropertyName other) => this.Name == other.Name;

        public override int GetHashCode() => this.Name.GetHashCode(StringComparison.InvariantCulture);
